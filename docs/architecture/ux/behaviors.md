...
| **Sidebar** | [components.md#sidebar](components.md#sidebar) | Hub navigation display |
| **Function Cards** | [components.md#function-cards](components.md#function-cards) | Card open mode configuration |
...
> **Related:** [components.md#sidebar](components.md#sidebar), [components.md#function-cards](components.md#function-cards)
...
Extend `ICardConfiguration` from [components.md#function-cards](components.md#function-cards):
...
> **Related:** [components.md#settings-panel](components.md#settings-panel), [personalization.md#interaction-patterns](personalization.md#interaction-patterns)
