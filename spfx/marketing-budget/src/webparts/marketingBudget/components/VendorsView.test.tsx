...
const mockVendors: Vendor[] = [
  { id: 1, name: 'Mountford Media', shortCode: 'MM', contactEmail: 'hello@mountford.com.au', contactPhone: '07 1234 5678', isActive: 1 },
...
const mockServices: Service[] = [
  {
    ...
    variantSelector: 'manual', variants: [{ id: 'default', name: 'Standard', basePrice: 100 }],
    includesGst: true, isActive: 1,
  },
  {
    id: 2, name: 'Aerial Photos', category: 'aerial', vendorId: 2,
    variantSelector: null, variants: [{ id: 'default', name: 'Standard', basePrice: 250 }],
    includesGst: true, isActive: 1,
  },
];
