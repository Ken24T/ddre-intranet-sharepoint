...
describe('seedData module', () => {
  ...
  describe('vendor data shape', () => {
    it('Mountford Media has correct shortCode', () => {
      const data = getSeedData();
      const mm = (data.vendors as Vendor[]).find((v) => v.name === 'Mountford Media');
    ...
    it('Urban Angles has correct shortCode', () => {
      const data = getSeedData();
      const ua = (data.vendors as Vendor[]).find((v) => v.name === 'Urban Angles');
  ...
  describe('suburb data integrity', () => {
    ...
    it('Bardon is Tier A', () => {
      const data = getSeedData();
      const bardon = (data.suburbs as Suburb[]).find((s) => s.name === 'Bardon');
    ...
    it('Chapel Hill is Tier D', () => {
      const data = getSeedData();
      const ch = (data.suburbs as Suburb[]).find((s) => s.name === 'Chapel Hill');
